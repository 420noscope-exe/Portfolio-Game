...
public class EXPRoverHealthController : MonoBehaviour, HealthController
{

    public int health;
    public int maxHealth = 10;
    private EXPRoverAI expRoverAI;
    ...
    {
        health = maxHealth;
        expRoverAI = gameObject.GetComponent<EXPRoverAI>();
